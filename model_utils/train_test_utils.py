...
def pair_stage_model_main(config, pair_representation, make_pair_label, pair_eval, polarities,
    ...
    train_polarity_representation, train_polarities = polarities
    ...
    train_polarity_loader = data_loader_utils.get_loader([train_polarity_representation, train_polarities], 16)
