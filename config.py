...
def makeParser():
  ...
  parser.add_argument("--do-train-part1", help="whether to train part 1", type=bool, default=True)
  parser.add_argument("--do-train-part2", help="whether to train part 2", type=bool, default=True)
  parser.add_argument("--log-progress", default=True, action=argparse.BooleanOptionalAction)
  ...
  parser.add_argument("--save-model", help="whether to save model", type=bool, default=True)
  parser.add_argument("--load-model", help="whether to load model", type=bool, default=False)
