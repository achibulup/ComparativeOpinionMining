...
def loadConfig(args):
  global VNCORENLP_JAR_PATH, DATA_PATH, DEVICE, SEED, SAVE_MODEL, LOAD_MODEL, MODEL_PATH, SAVE_MODEL_PATH, DO_TRAIN_PART1, DO_TRAIN_PART2, BATCH_SIZE, EPOCHS, POSTIVE_RATE, LR, BINARY_WEIGHT
